...
Version  : 5.14.0
Release  : 8
URL      : https://github.com/qt/qtmqtt/archive/v5.14.0/qtmqtt-everywhere-src-5.14.0.tar.gz
Source0  : https://github.com/qt/qtmqtt/archive/v5.14.0/qtmqtt-everywhere-src-5.14.0.tar.gz
...
%prep
%setup -q -n qtmqtt-5.14.0
cd %{_builddir}/qtmqtt-5.14.0
...
%install
export SOURCE_DATE_EPOCH=1576270529
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/qtmqtt
cp %{_builddir}/qtmqtt-5.14.0/LICENSE.GPL3 %{buildroot}/usr/share/package-licenses/qtmqtt/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/qtmqtt-5.14.0/LICENSE.GPL3-EXCEPT %{buildroot}/usr/share/package-licenses/qtmqtt/e93757aefa405f2c9a8a55e780ae9c39542dfc3a
%make_install
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtMqtt/5.14.0/QtMqtt/private/qmqttclient_p.h
/usr/include/qt5/QtMqtt/5.14.0/QtMqtt/private/qmqttconnection_p.h
/usr/include/qt5/QtMqtt/5.14.0/QtMqtt/private/qmqttconnectionproperties_p.h
/usr/include/qt5/QtMqtt/5.14.0/QtMqtt/private/qmqttcontrolpacket_p.h
/usr/include/qt5/QtMqtt/5.14.0/QtMqtt/private/qmqttmessage_p.h
/usr/include/qt5/QtMqtt/5.14.0/QtMqtt/private/qmqttpublishproperties_p.h
/usr/include/qt5/QtMqtt/5.14.0/QtMqtt/private/qmqttsubscription_p.h
...
/usr/lib64/libQt5Mqtt.so.5.14.0
